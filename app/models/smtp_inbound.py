...
class SmtpInboundMessage(Base):
    ...
    inbound_address_id: Mapped[Optional[str]] = mapped_column(
    ...
    envelope_sender: Mapped[Optional[str]] = mapped_column(String(320), nullable=True)
    envelope_recipient: Mapped[str] = mapped_column(String(320), nullable=False, index=True)
    remote_ip: Mapped[Optional[str]] = mapped_column(String(45), nullable=True, index=True)
    header_from: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    header_to: Mapped[Optional[str]] = mapped_column(String(1000), nullable=True)
...
class SmtpInboundRejection(Base):
    ...
    id: Mapped[str] = uuid_pk()
    remote_ip: Mapped[Optional[str]] = mapped_column(String(45), nullable=True, index=True)
    attempted_recipient: Mapped[Optional[str]] = mapped_column(String(320), nullable=True, index=True)
